...
std::ostream &operator << (std::ostream &outputStream, const int & obj);
...
template <class T>
T &SimpleVector::push_back<T>(string item)
{
...
template <class T>
T &SimpleVector::pop_back(string item)
{

	StringVector.pop_back(item);
...
/*
std::ostream &operator << (std::ostream &outputStream, const Integer & obj)
{
